...
Eventually we found the following TODO blog post which guided me to the the legendary reverse engineering relic - [exetools][exetools].
...
The qtext cracker script in its entirety can found here.
